...
class m160131_124523_init_demo extends Migration
{
    public function up()
    {
        ...
        $this->insert('{{%post_category}}', ['id' => '1', 'slug' => 'first-category', 'created_by' => 1, 'updated_by' => 1, 'visible' => 1, 'left_border' => 42107523, 'right_border' => 84215044, 'depth' => 1, 'created_at' => time(), 'updated_at' => time()]);
